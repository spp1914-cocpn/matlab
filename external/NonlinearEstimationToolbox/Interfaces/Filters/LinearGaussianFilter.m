...
classdef LinearGaussianFilter < GaussianFilter
    ...
    methods (Sealed)
        ...
        function [measurement, ...
                  measMean, ...
                  measCov, ...
                  stateMeasCrossCov] = getLastUpdateData(obj)
            ...
            %
            measurement       = obj.lastUpdateData.measurement;
            measMean          = obj.lastUpdateData.measMean;
            measCov           = obj.lastUpdateData.measCov;
            stateMeasCrossCov = obj.lastUpdateData.stateMeasCrossCov;
        end
    end
    ...
    methods (Sealed, Access = 'protected')
        function [updatedStateMean, ...
            ...
            if Checks.isClass(measModel, 'LinearMeasurementModel')
                [updatedStateMean, ...
                 updatedStateCov, obj.lastUpdateData] = obj.updateLinearMeasModel(measModel, measurement, ...
                                                              priorStateMean, priorStateCov, priorStateCovSqrt);
            else
                ...
                [updatedStateMean, ...
                 updatedStateCov, obj.lastUpdateData] = obj.updateNonlinear(measurement, ...
                                                        priorStateMean, priorStateCov, priorStateCovSqrt);
            end
        end
        
        function [updatedStateMean, ...
                  updatedStateCov, updateData] = updateLinearMeasModel(obj, measModel, measurement, ...
                                                           priorStateMean, priorStateCov, priorStateCovSqrt)
            [measMean, measCov, ...
            ...
            updateData.measMean = measMean;
            updateData.measCov = measCov;
            updateData.stateMeasCrossCov = stateMeasCrossCov;
        end
    ...
    methods (Abstract, Access = 'protected')
        ...
        [updatedStateMean, ...
         updatedStateCov, updateData] = updateNonlinear(obj, measurement, ...
                                            priorStateMean, priorStateCov, priorStateCovSqrt);
    end
    ...
    properties (Access = 'private')
        ...
        % struct containing measurement, measMean, measCov and stateMeasCrossCov
        lastUpdateData;
    end
end