classdef LinearlyConstrainedPredictiveControllerTest < matlab.unittest.TestCase
    ...
    methods (TestMethodSetup)
        ...
        function initProperties(this)
            ...
            % corresponding mode transition matrix
            probs = zeros(1, 11);
            probs(2) = 1;            
            this.modeTransitionMatrix = Utility.calculateDelayTransitionMatrix(probs);
        ...
        function setupControllerUnderTest(this, doTrackRef)
            if doTrackRef
                this.controllerUnderTest = LinearlyConstrainedPredictiveController(this.A, this.B, this.Qref, this.R, this.sequenceLength, ...
                    this.modeTransitionMatrix, this.stateConstraintWeightings, this.stateConstraints, this.inputConstraintWeightings, this.inputConstraints, ...
    ...
    methods (Test)
        ...
        function testLinearlyConstrainedPredictiveControllerInvalidSysMatrix(this)              
            ...
            this.verifyError(@() LinearlyConstrainedPredictiveController(invalidA, this.B, this.Q, this.R, ...
                this.sequenceLength, this.modeTransitionMatrix, this.stateConstraintWeightings, this.stateConstraints, ...
        ...
        function testLinearlyConstrainedPredictiveControllerInvalidStateConstraints(this) %#ok            
            ...
            this.verifyError(@() LinearlyConstrainedPredictiveController(this.A, this.B, this.Q, this.R, ...
                this.sequenceLength, this.modeTransitionMatrix, invalidStateConstraintWeightings, this.stateConstraints, ...
                this.inputConstraintWeightings, this.inputConstraints), ...
                expectedErrId);
            ...
            this.verifyError(@() LinearlyConstrainedPredictiveController(this.A, this.B, this.Q, this.R, ...
                this.sequenceLength, this.modeTransitionMatrix, this.stateConstraintWeightings, invalidStateConstraints, ...
                this.inputConstraintWeightings, this.inputConstraints), ...
                expectedErrId);
...
%%
        ...
        function testLinearlyConstrainedPredictiveController(this)            
            % should not crash
            controller = LinearlyConstrainedPredictiveController(this.A, this.B, this.Q, this.R, this.sequenceLength, this.modeTransitionMatrix, ...
